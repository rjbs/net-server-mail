# This Makefile is for the Net::Server::Mail extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Server/Mail.pm]
#     AUTHOR => q[Olivier Poitrey <rs@rhapsodyk.net>]
#     NAME => q[Net::Server::Mail]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Net/Server/Mail.pm]
...
DISTNAME = Net-Server-Mail
NAME_SYM = Net_Server_Mail
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
...
FULLEXT = Net/Server/Mail
BASEEXT = Mail
PARENT_NAME = Net::Server
DLBASE = $(BASEEXT)
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/Net/Server/Mail.pm \
	lib/Net/Server/Mail/ESMTP.pm \
	lib/Net/Server/Mail/ESMTP/Extension.pm \
	lib/Net/Server/Mail/LMTP.pm \
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Net/Server
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Server
...
TO_INST_PM = lib/Net/Server/Mail.pm \
	lib/Net/Server/Mail/ESMTP.pm \
	lib/Net/Server/Mail/ESMTP/8BITMIME.pm \
	lib/Net/Server/Mail/ESMTP/Extension.pm \
	lib/Net/Server/Mail/ESMTP/PIPELINING.pm \
	lib/Net/Server/Mail/LMTP.pm \
	lib/Net/Server/Mail/SMTP.pm

PM_TO_BLIB = lib/Net/Server/Mail/LMTP.pm \
	blib/lib/Net/Server/Mail/LMTP.pm \
	lib/Net/Server/Mail/ESMTP/Extension.pm \
	blib/lib/Net/Server/Mail/ESMTP/Extension.pm \
	lib/Net/Server/Mail/ESMTP/8BITMIME.pm \
	blib/lib/Net/Server/Mail/ESMTP/8BITMIME.pm \
	lib/Net/Server/Mail/ESMTP/PIPELINING.pm \
	blib/lib/Net/Server/Mail/ESMTP/PIPELINING.pm \
	lib/Net/Server/Mail/SMTP.pm \
	blib/lib/Net/Server/Mail/SMTP.pm \
	lib/Net/Server/Mail/ESMTP.pm \
	blib/lib/Net/Server/Mail/ESMTP.pm \
	lib/Net/Server/Mail.pm \
...
manifypods : pure_all lib/Net/Server/Mail/LMTP.pm \
	lib/Net/Server/Mail/ESMTP/Extension.pm \
	lib/Net/Server/Mail/SMTP.pm \
	lib/Net/Server/Mail/ESMTP.pm \
	lib/Net/Server/Mail.pm
	@$(POD2MAN) \
	lib/Net/Server/Mail/LMTP.pm \
	$(INST_MAN3DIR)/Net::Server::Mail::LMTP.$(MAN3EXT) \
	lib/Net/Server/Mail/ESMTP/Extension.pm \
	$(INST_MAN3DIR)/Net::Server::Mail::ESMTP::Extension.$(MAN3EXT) \
	lib/Net/Server/Mail/SMTP.pm \
	$(INST_MAN3DIR)/Net::Server::Mail::SMTP.$(MAN3EXT) \
	lib/Net/Server/Mail/ESMTP.pm \
	$(INST_MAN3DIR)/Net::Server::Mail::ESMTP.$(MAN3EXT) \
	lib/Net/Server/Mail.pm \
	$(INST_MAN3DIR)/Net::Server::Mail.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Net/Server/Mail/LMTP.pm blib/lib/Net/Server/Mail/ESMTP/Extension.pm
	rm -f blib/lib/Net/Server/Mail/ESMTP/8BITMIME.pm
	rm -f blib/lib/Net/Server/Mail/ESMTP/PIPELINING.pm blib/lib/Net/Server/Mail/SMTP.pm
	rm -f blib/lib/Net/Server/Mail/ESMTP.pm blib/lib/Net/Server/Mail.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,01,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>Class to easily create a mail server</ABSTRACT>\n\t<AUTHOR>Olivier Poitrey &lt;rs\@rhapsodyk.net&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/Net/Server/Mail/LMTP.pm blib/lib/Net/Server/Mail/LMTP.pm lib/Net/Server/Mail/ESMTP/Extension.pm blib/lib/Net/Server/Mail/ESMTP/Extension.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{lib/Net/Server/Mail/ESMTP/8BITMIME.pm blib/lib/Net/Server/Mail/ESMTP/8BITMIME.pm lib/Net/Server/Mail/ESMTP/PIPELINING.pm blib/lib/Net/Server/Mail/ESMTP/PIPELINING.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{lib/Net/Server/Mail.pm blib/lib/Net/Server/Mail.pm lib/Net/Server/Mail/ESMTP.pm blib/lib/Net/Server/Mail/ESMTP.pm lib/Net/Server/Mail/SMTP.pm blib/lib/Net/Server/Mail/SMTP.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
